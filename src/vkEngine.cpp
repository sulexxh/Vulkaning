...
void initSwapchain() {
    ...
    */
    window = SDL_CreateWindow("Vulkaning", 1280u, 720u, SDL_WINDOW_VULKAN | SDL_WINDOW_RESIZABLE);
...
void initModel() {
    ...
    */
    ...
    iBufSize = sizeof(uint16_t) * indices.size();
    ...
    */
    ...
    /*
        ...
        we require one vertex binding point. The stride matches the size of the vertex structure as our vertices are
        ...
        */
        ...
        for (SDL_Event event; SDL_PollEvent(&event);) {
            ...
            if (event.type == SDL_EVENT_MOUSE_WHEEL) {
                camPos.z += static_cast<float>(event.wheel.y) * elapsedTime * 100.0f;
            }
...
void cleanup() {
    if (!init) {
        std::cerr << "Vulkan not fully initialised!\n";
        return;
    }
